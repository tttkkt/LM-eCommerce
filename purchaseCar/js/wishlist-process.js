    ...
    function displayWishlistItems() {
        ...
        if (wishlist.length === 0) {
            ...
            wishlist.forEach((item, index) => {
                // Determine the checkout button classes and text based on index
                const checkoutBtnClass = index === 0 ? 'checkout-btn-color-processing' : 'checkout-btn-color';
                const checkoutBtnText = index === 0 ? 'Processing' : 'Check Out';
                ...
                wishlistContainer.append(`
                    <div class="wishlist-item">
                        ...
                        <a class="checkout-btn ${checkoutBtnClass}" href="checkout.html">
                            <span class="checkout-btn-name">${checkoutBtnText}</span>
